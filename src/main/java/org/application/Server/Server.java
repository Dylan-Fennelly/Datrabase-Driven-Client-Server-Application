...
public class Server
{
    public static void main(String[] args)
    {
        try {
            ...
            ServerSocket listeningSocket = new ServerSocket(ServerDetails.SERVER_PORT);
            ...
            while (continueRunning) {
                ...
                //4. Maybe other stuff
                ServerThreadPerClient newClient = new ServerThreadPerClient(clientThreads, dataSocket.getInetAddress() + "", dataSocket, numberClients);
