...
public class ServiceThread extends Thread
{
    ...
    public ServiceThread(ThreadGroup clientThreads, String s, Socket dataSocket, int number)
    {
    ...
    public void run()
    {
        ...
        try
        {
            ...
            while (!incomingMessage.equals(Details.EXIT_COMMAND))
            {
                ...
                String[] messageParts = incomingMessage.split(Details.BREAKING_CHARACTERS);

                //Process the message
                //Use the command factory to create the command object
                CommandFactory commandFactory = new CommandFactory();
                Command command = CommandFactory.getCommand(messageParts[0]);
                //Execute the command
